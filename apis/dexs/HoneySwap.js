...
import { priceImp, maxBuyFee, maxSellFee, XDAIaddress, ownerAddress } from '../../config/const.js';
import { XDAIprovider as provider } from '../../startConnection.js';
var web3 = new Web3(provider);

// const
const mainTokenAddress = '0xe91d153e0b41518a2ce8dd3d7944fa863463a97d'; // WXDAI
const routerAddress = '0x1C232F01118CB8B424793ae03F870aa7D0ac7f77';
const multicallAddress = XDAIaddress;
const mainTokentoSell = '1';
...
const routerAbi = [
  ...
  { type: 'function', stateMutability: 'view', outputs: [{ type: 'address', name: '', internalType: 'address' }], name: 'WETH', inputs: [] },
  {
    type: 'function',
    stateMutability: 'nonpayable',
    outputs: [
  ...
  },
  {
    type: 'function',
    stateMutability: 'nonpayable',
    outputs: [{ type: 'uint256', name: 'amountETH', internalType: 'uint256' }],
